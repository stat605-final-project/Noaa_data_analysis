...
The data we used in our project is NOAA Global Historical Climatology Network(GHCN) Daily, which is an integrated database of daily climate summaries from land surface stations across the globe. 
